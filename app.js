...
document.addEventListener('click', function(e){
  ...
  const posts = [
    {id:'guia-compatibilidade-quimica',imagem:'/img/blog-compatibilidade-quimica.jpg',titulo:'Guia de Compatibilidade Química: meios filtrantes e vedações',data:'22 de setembro de 2026',dataIso:'2026-09-22',tempo:'2 min de leitura',cat:'processo',catNome:'Dimensionamento & Processo',featured:false,resumo:'Tabela de consulta rápida com a resistência de PP, PES, PTFE, PVDF e Nylon, e das vedações em silicone, FKM e EPDM, a 60 produtos químicos comuns de processo.',tags:['Compatibilidade química','Guia técnico','PES','PTFE','PVDF','Nylon','Vedações'],conteudo:'\n        <p>A compatibilidade química é um dos primeiros pontos a verificar na escolha de um filtro. A tabela abaixo reúne, de forma orientativa, a resistência dos principais meios filtrantes e dos elastômeros de vedação a produtos químicos comuns de processo.</p>\n        <p>Vale conferir as duas partes da tabela: em um cartucho, o meio filtrante e a vedação ficam em contato com o mesmo fluido, e ambos precisam ser compatíveis.</p>\n        <div class="compat-legenda"><div><span class="cq r">R</span><b>Recomendado</b><small>Material compatível com o produto químico.</small></div><div><span class="cq rl">RL</span><b>Recomendação limitada</b><small>Uso possível sob condições controladas de concentração, temperatura e tempo de contato.</small></div><div><span class="cq nr">NR</span><b>Não recomendado</b><small>Risco de ataque ao material. Prefira outro meio filtrante ou outra vedação.</small></div><div><span class="cq sd">—</span><b>Sem dados</b><small>Combinação não avaliada. Consulte a Verter para a sua aplicação.</small></div></div>\n        <div class="compat-ferramentas">\n          <label class="compat-busca"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg><input type="search" id="compat-busca" placeholder="Buscar produto químico…" autocomplete="off" spellcheck="false" aria-label="Buscar produto químico na tabela"></label>\n          <a class="compat-pdf" href="/guia-compatibilidade-quimica-verter.pdf" download><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 3v12m0 0-5-5m5 5 5-5M4 21h16"/></svg>Baixar PDF</a>\n        </div>\n        <div class="compat-wrap"><table class="compat-tabela"><thead><tr class="compat-topo"><th rowspan="2" class="compat-th-prod">Produto químico</th><th colspan="5" class="compat-th-grupo">Meios filtrantes</th><th colspan="3" class="compat-th-grupo vedacao compat-sep">Elastômeros de vedação</th></tr><tr class="compat-mats"><th class=""><span>PP</span><small>polipropileno</small></th><th class=""><span>PES</span><small>polietersulfona</small></th><th class=""><span>PTFE</span><small>politetrafluoretileno</small></th><th class=""><span>PVDF</span><small>fluoreto de polivinilideno</small></th><th class=""><span>Nylon</span><small>poliamida</small></th><th class="compat-sep"><span>Silicone</span><small>VMQ</small></th><th class=""><span>FKM</span><small>fluorelastômero</small></th><th class=""><span>EPDM</span><small>etileno-propileno</small></th></tr></thead><tbody><tr class="compat-grupo"><th colspan="9" scope="rowgroup">Ácidos</th></tr><tr class="compat-linha" data-nome="Ácido acético glacial"><th scope="row">Ácido acético glacial</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq nr" title="PES: Não recomendado">NR</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq nr" title="Nylon: Não recomendado">NR</span></td><td class="compat-sep"><span class="cq rl" title="Silicone: Recomendação limitada">RL</span></td><td class=""><span class="cq nr" title="FKM: Não recomendado">NR</span></td><td class=""><span class="cq rl" title="EPDM: Recomendação limitada">RL</span></td></tr><tr class="compat-linha" data-nome="Ácido clorídrico concentrado"><th scope="row">Ácido clorídrico concentrado</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq r" title="PES: Recomendado">R</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq nr" title="Nylon: Não recomendado">NR</span></td><td class="compat-sep"><span class="cq nr" title="Silicone: Não recomendado">NR</span></td><td class=""><span class="cq r" title="FKM: Recomendado">R</span></td><td class=""><span class="cq rl" title="EPDM: Recomendação limitada">RL</span></td></tr><tr class="compat-linha" data-nome="Ácido clorídrico 6 N"><th scope="row">Ácido clorídrico 6 N</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq r" title="PES: Recomendado">R</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq nr" title="Nylon: Não recomendado">NR</span></td><td class="compat-sep"><span class="cq nr" title="Silicone: Não recomendado">NR</span></td><td class=""><span class="cq r" title="FKM: Recomendado">R</span></td><td class=""><span class="cq rl" title="EPDM: Recomendação limitada">RL</span></td></tr><tr class="compat-linha" data-nome="Ácido nítrico concentrado"><th scope="row">Ácido nítrico concentrado</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq sd" title="PES: Sem dados">—</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq nr" title="Nylon: Não recomendado">NR</span></td><td class="compat-sep"><span class="cq rl" title="Silicone: Recomendação limitada">RL</span></td><td class=""><span class="cq rl" title="FKM: Recomendação limitada">RL</span></td><td class=""><span class="cq nr" title="EPDM: Não recomendado">NR</span></td></tr><tr class="compat-linha" data-nome="Ácido nítrico 6 N"><th scope="row">Ácido nítrico 6 N</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq sd" title="PES: Sem dados">—</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq nr" title="Nylon: Não recomendado">NR</span></td><td class="compat-sep"><span class="cq rl" title="Silicone: Recomendação limitada">RL</span></td><td class=""><span class="cq r" title="FKM: Recomendado">R</span></td><td class=""><span class="cq nr" title="EPDM: Não recomendado">NR</span></td></tr><tr class="compat-linha" data-nome="Ácido fosfórico concentrado"><th scope="row">Ácido fosfórico concentrado</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq sd" title="PES: Sem dados">—</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq rl" title="Nylon: Recomendação limitada">RL</span></td><td class="compat-sep"><span class="cq nr" title="Silicone: Não recomendado">NR</span></td><td class=""><span class="cq r" title="FKM: Recomendado">R</span></td><td class=""><span class="cq nr" title="EPDM: Não recomendado">NR</span></td></tr><tr class="compat-linha" data-nome="Ácido sulfúrico concentrado"><th scope="row">Ácido sulfúrico concentrado</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq nr" title="PES: Não recomendado">NR</span></td><td class=""><span class="cq rl" title="PTFE: Recomendação limitada">RL</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq nr" title="Nylon: Não recomendado">NR</span></td><td class="compat-sep"><span class="cq nr" title="Silicone: Não recomendado">NR</span></td><td class=""><span class="cq r" title="FKM: Recomendado">R</span></td><td class=""><span class="cq nr" title="EPDM: Não recomendado">NR</span></td></tr><tr class="compat-linha" data-nome="Ácido bórico"><th scope="row">Ácido bórico</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq r" title="PES: Recomendado">R</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq r" title="Nylon: Recomendado">R</span></td><td class="compat-sep"><span class="cq r" title="Silicone: Recomendado">R</span></td><td class=""><span class="cq r" title="FKM: Recomendado">R</span></td><td class=""><span class="cq r" title="EPDM: Recomendado">R</span></td></tr><tr class="compat-linha" data-nome="Ácido fluorídrico 6 N"><th scope="row">Ácido fluorídrico 6 N</th><td class=""><span class="cq nr" title="PP: Não recomendado">NR</span></td><td class=""><span class="cq sd" title="PES: Sem dados">—</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq nr" title="Nylon: Não recomendado">NR</span></td><td class="compat-sep"><span class="cq nr" title="Silicone: Não recomendado">NR</span></td><td class=""><span class="cq sd" title="FKM: Sem dados">—</span></td><td class=""><span class="cq nr" title="EPDM: Não recomendado">NR</span></td></tr></tbody><tbody><tr class="compat-grupo"><th colspan="9" scope="rowgroup">Álcalis</th></tr><tr class="compat-linha" data-nome="Hidróxido de amônio"><th scope="row">Hidróxido de amônio</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq r" title="PES: Recomendado">R</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq rl" title="PVDF: Recomendação limitada">RL</span></td><td class=""><span class="cq r" title="Nylon: Recomendado">R</span></td><td class="compat-sep"><span class="cq r" title="Silicone: Recomendado">R</span></td><td class=""><span class="cq r" title="FKM: Recomendado">R</span></td><td class=""><span class="cq rl" title="EPDM: Recomendação limitada">RL</span></td></tr><tr class="compat-linha" data-nome="Hidróxido de potássio 3 N"><th scope="row">Hidróxido de potássio 3 N</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq r" title="PES: Recomendado">R</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq rl" title="PVDF: Recomendação limitada">RL</span></td><td class=""><span class="cq r" title="Nylon: Recomendado">R</span></td><td class="compat-sep"><span class="cq rl" title="Silicone: Recomendação limitada">RL</span></td><td class=""><span class="cq r" title="FKM: Recomendado">R</span></td><td class=""><span class="cq r" title="EPDM: Recomendado">R</span></td></tr><tr class="compat-linha" data-nome="Hidróxido de sódio 3 N"><th scope="row">Hidróxido de sódio 3 N</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq r" title="PES: Recomendado">R</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq rl" title="PVDF: Recomendação limitada">RL</span></td><td class=""><span class="cq r" title="Nylon: Recomendado">R</span></td><td class="compat-sep"><span class="cq r" title="Silicone: Recomendado">R</span></td><td class=""><span class="cq r" title="FKM: Recomendado">R</span></td><td class=""><span class="cq r" title="EPDM: Recomendado">R</span></td></tr><tr class="compat-linha" data-nome="Hidróxido de sódio 6 N"><th scope="row">Hidróxido de sódio 6 N</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq r" title="PES: Recomendado">R</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq nr" title="PVDF: Não recomendado">NR</span></td><td class=""><span class="cq r" title="Nylon: Recomendado">R</span></td><td class="compat-sep"><span class="cq r" title="Silicone: Recomendado">R</span></td><td class=""><span class="cq r" title="FKM: Recomendado">R</span></td><td class=""><span class="cq rl" title="EPDM: Recomendação limitada">RL</span></td></tr></tbody><tbody><tr class="compat-grupo"><th colspan="9" scope="rowgroup">Hidrocarbonetos halogenados</th></tr><tr class="compat-linha" data-nome="Tetracloreto de carbono"><th scope="row">Tetracloreto de carbono</th><td class=""><span class="cq rl" title="PP: Recomendação limitada">RL</span></td><td class=""><span class="cq rl" title="PES: Recomendação limitada">RL</span></td><td class=""><span class="cq rl" title="PTFE: Recomendação limitada">RL</span></td><td class=""><span class="cq rl" title="PVDF: Recomendação limitada">RL</span></td><td class=""><span class="cq rl" title="Nylon: Recomendação limitada">RL</span></td><td class="compat-sep"><span class="cq nr" title="Silicone: Não recomendado">NR</span></td><td class=""><span class="cq r" title="FKM: Recomendado">R</span></td><td class=""><span class="cq nr" title="EPDM: Não recomendado">NR</span></td></tr><tr class="compat-linha" data-nome="Triclorometano (clorofórmio)"><th scope="row">Triclorometano (clorofórmio)</th><td class=""><span class="cq rl" title="PP: Recomendação limitada">RL</span></td><td class=""><span class="cq nr" title="PES: Não recomendado">NR</span></td><td class=""><span class="cq rl" title="PTFE: Recomendação limitada">RL</span></td><td class=""><span class="cq rl" title="PVDF: Recomendação limitada">RL</span></td><td class=""><span class="cq nr" title="Nylon: Não recomendado">NR</span></td><td class="compat-sep"><span class="cq nr" title="Silicone: Não recomendado">NR</span></td><td class=""><span class="cq r" title="FKM: Recomendado">R</span></td><td class=""><span class="cq nr" title="EPDM: Não recomendado">NR</span></td></tr><tr class="compat-linha" data-nome="Dicloroetileno"><th scope="row">Dicloroetileno</th><td class=""><span class="cq rl" title="PP: Recomendação limitada">RL</span></td><td class=""><span class="cq nr" title="PES: Não recomendado">NR</span></td><td class=""><span class="cq rl" title="PTFE: Recomendação limitada">RL</span></td><td class=""><span class="cq rl" title="PVDF: Recomendação limitada">RL</span></td><td class=""><span class="cq rl" title="Nylon: Recomendação limitada">RL</span></td><td class="compat-sep"><span class="cq nr" title="Silicone: Não recomendado">NR</span></td><td class=""><span class="cq rl" title="FKM: Recomendação limitada">RL</span></td><td class=""><span class="cq rl" title="EPDM: Recomendação limitada">RL</span></td></tr><tr class="compat-linha" data-nome="Freon TF"><th scope="row">Freon TF</th><td class=""><span class="cq rl" title="PP: Recomendação limitada">RL</span></td><td class=""><span class="cq rl" title="PES: Recomendação limitada">RL</span></td><td class=""><span class="cq rl" title="PTFE: Recomendação limitada">RL</span></td><td class=""><span class="cq rl" title="PVDF: Recomendação limitada">RL</span></td><td class=""><span class="cq rl" title="Nylon: Recomendação limitada">RL</span></td><td class="compat-sep"><span class="cq nr" title="Silicone: Não recomendado">NR</span></td><td class=""><span class="cq r" title="FKM: Recomendado">R</span></td><td class=""><span class="cq nr" title="EPDM: Não recomendado">NR</span></td></tr><tr class="compat-linha" data-nome="Freon TMC"><th scope="row">Freon TMC</th><td class=""><span class="cq rl" title="PP: Recomendação limitada">RL</span></td><td class=""><span class="cq nr" title="PES: Não recomendado">NR</span></td><td class=""><span class="cq rl" title="PTFE: Recomendação limitada">RL</span></td><td class=""><span class="cq rl" title="PVDF: Recomendação limitada">RL</span></td><td class=""><span class="cq rl" title="Nylon: Recomendação limitada">RL</span></td><td class="compat-sep"><span class="cq nr" title="Silicone: Não recomendado">NR</span></td><td class=""><span class="cq rl" title="FKM: Recomendação limitada">RL</span></td><td class=""><span class="cq nr" title="EPDM: Não recomendado">NR</span></td></tr><tr class="compat-linha" data-nome="Diclorometano"><th scope="row">Diclorometano</th><td class=""><span class="cq rl" title="PP: Recomendação limitada">RL</span></td><td class=""><span class="cq nr" title="PES: Não recomendado">NR</span></td><td class=""><span class="cq rl" title="PTFE: Recomendação limitada">RL</span></td><td class=""><span class="cq rl" title="PVDF: Recomendação limitada">RL</span></td><td class=""><span class="cq nr" title="Nylon: Não recomendado">NR</span></td><td class="compat-sep"><span class="cq nr" title="Silicone: Não recomendado">NR</span></td><td class=""><span class="cq rl" title="FKM: Recomendação limitada">RL</span></td><td class=""><span class="cq nr" title="EPDM: Não recomendado">NR</span></td></tr><tr class="compat-linha" data-nome="Tricloroetileno"><th scope="row">Tricloroetileno</th><td class=""><span class="cq rl" title="PP: Recomendação limitada">RL</span></td><td class=""><span class="cq rl" title="PES: Recomendação limitada">RL</span></td><td class=""><span class="cq rl" title="PTFE: Recomendação limitada">RL</span></td><td class=""><span class="cq nr" title="PVDF: Não recomendado">NR</span></td><td class=""><span class="cq rl" title="Nylon: Recomendação limitada">RL</span></td><td class="compat-sep"><span class="cq nr" title="Silicone: Não recomendado">NR</span></td><td class=""><span class="cq r" title="FKM: Recomendado">R</span></td><td class=""><span class="cq nr" title="EPDM: Não recomendado">NR</span></td></tr></tbody><tbody><tr class="compat-grupo"><th colspan="9" scope="rowgroup">Álcoois</th></tr><tr class="compat-linha" data-nome="Álcool amílico"><th scope="row">Álcool amílico</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq r" title="PES: Recomendado">R</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq r" title="Nylon: Recomendado">R</span></td><td class="compat-sep"><span class="cq nr" title="Silicone: Não recomendado">NR</span></td><td class=""><span class="cq r" title="FKM: Recomendado">R</span></td><td class=""><span class="cq r" title="EPDM: Recomendado">R</span></td></tr><tr class="compat-linha" data-nome="Álcool benzílico 100%"><th scope="row">Álcool benzílico 100%</th><td class=""><span class="cq nr" title="PP: Não recomendado">NR</span></td><td class=""><span class="cq nr" title="PES: Não recomendado">NR</span></td><td class=""><span class="cq nr" title="PTFE: Não recomendado">NR</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq nr" title="Nylon: Não recomendado">NR</span></td><td class="compat-sep"><span class="cq rl" title="Silicone: Recomendação limitada">RL</span></td><td class=""><span class="cq r" title="FKM: Recomendado">R</span></td><td class=""><span class="cq r" title="EPDM: Recomendado">R</span></td></tr><tr class="compat-linha" data-nome="Butanol"><th scope="row">Butanol</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq r" title="PES: Recomendado">R</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq r" title="Nylon: Recomendado">R</span></td><td class="compat-sep"><span class="cq nr" title="Silicone: Não recomendado">NR</span></td><td class=""><span class="cq r" title="FKM: Recomendado">R</span></td><td class=""><span class="cq nr" title="EPDM: Não recomendado">NR</span></td></tr><tr class="compat-linha" data-nome="Etanol"><th scope="row">Etanol</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq r" title="PES: Recomendado">R</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq r" title="Nylon: Recomendado">R</span></td><td class="compat-sep"><span class="cq r" title="Silicone: Recomendado">R</span></td><td class=""><span class="cq r" title="FKM: Recomendado">R</span></td><td class=""><span class="cq r" title="EPDM: Recomendado">R</span></td></tr><tr class="compat-linha" data-nome="Isopropanol"><th scope="row">Isopropanol</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq r" title="PES: Recomendado">R</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq r" title="Nylon: Recomendado">R</span></td><td class="compat-sep"><span class="cq r" title="Silicone: Recomendado">R</span></td><td class=""><span class="cq r" title="FKM: Recomendado">R</span></td><td class=""><span class="cq r" title="EPDM: Recomendado">R</span></td></tr><tr class="compat-linha" data-nome="Metanol"><th scope="row">Metanol</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq r" title="PES: Recomendado">R</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq r" title="Nylon: Recomendado">R</span></td><td class="compat-sep"><span class="cq r" title="Silicone: Recomendado">R</span></td><td class=""><span class="cq r" title="FKM: Recomendado">R</span></td><td class=""><span class="cq r" title="EPDM: Recomendado">R</span></td></tr><tr class="compat-linha" data-nome="Etilenoglicol"><th scope="row">Etilenoglicol</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq rl" title="PES: Recomendação limitada">RL</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq r" title="Nylon: Recomendado">R</span></td><td class="compat-sep"><span class="cq r" title="Silicone: Recomendado">R</span></td><td class=""><span class="cq r" title="FKM: Recomendado">R</span></td><td class=""><span class="cq r" title="EPDM: Recomendado">R</span></td></tr><tr class="compat-linha" data-nome="Glicerina"><th scope="row">Glicerina</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq rl" title="PES: Recomendação limitada">RL</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq r" title="Nylon: Recomendado">R</span></td><td class="compat-sep"><span class="cq r" title="Silicone: Recomendado">R</span></td><td class=""><span class="cq r" title="FKM: Recomendado">R</span></td><td class=""><span class="cq r" title="EPDM: Recomendado">R</span></td></tr><tr class="compat-linha" data-nome="Propilenoglicol"><th scope="row">Propilenoglicol</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq rl" title="PES: Recomendação limitada">RL</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq r" title="Nylon: Recomendado">R</span></td><td class="compat-sep"><span class="cq r" title="Silicone: Recomendado">R</span></td><td class=""><span class="cq r" title="FKM: Recomendado">R</span></td><td class=""><span class="cq r" title="EPDM: Recomendado">R</span></td></tr></tbody><tbody><tr class="compat-grupo"><th colspan="9" scope="rowgroup">Éteres</th></tr><tr class="compat-linha" data-nome="Éter dietílico"><th scope="row">Éter dietílico</th><td class=""><span class="cq rl" title="PP: Recomendação limitada">RL</span></td><td class=""><span class="cq rl" title="PES: Recomendação limitada">RL</span></td><td class=""><span class="cq rl" title="PTFE: Recomendação limitada">RL</span></td><td class=""><span class="cq rl" title="PVDF: Recomendação limitada">RL</span></td><td class=""><span class="cq nr" title="Nylon: Não recomendado">NR</span></td><td class="compat-sep"><span class="cq rl" title="Silicone: Recomendação limitada">RL</span></td><td class=""><span class="cq nr" title="FKM: Não recomendado">NR</span></td><td class=""><span class="cq nr" title="EPDM: Não recomendado">NR</span></td></tr><tr class="compat-linha" data-nome="Éter isopropílico"><th scope="row">Éter isopropílico</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq sd" title="PES: Sem dados">—</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq sd" title="Nylon: Sem dados">—</span></td><td class="compat-sep"><span class="cq nr" title="Silicone: Não recomendado">NR</span></td><td class=""><span class="cq nr" title="FKM: Não recomendado">NR</span></td><td class=""><span class="cq nr" title="EPDM: Não recomendado">NR</span></td></tr><tr class="compat-linha" data-nome="Dioxano"><th scope="row">Dioxano</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq sd" title="PES: Sem dados">—</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq nr" title="Nylon: Não recomendado">NR</span></td><td class="compat-sep"><span class="cq nr" title="Silicone: Não recomendado">NR</span></td><td class=""><span class="cq nr" title="FKM: Não recomendado">NR</span></td><td class=""><span class="cq sd" title="EPDM: Sem dados">—</span></td></tr><tr class="compat-linha" data-nome="Tetra-hidrofurano (THF)"><th scope="row">Tetra-hidrofurano (THF)</th><td class=""><span class="cq rl" title="PP: Recomendação limitada">RL</span></td><td class=""><span class="cq nr" title="PES: Não recomendado">NR</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq rl" title="PVDF: Recomendação limitada">RL</span></td><td class=""><span class="cq r" title="Nylon: Recomendado">R</span></td><td class="compat-sep"><span class="cq nr" title="Silicone: Não recomendado">NR</span></td><td class=""><span class="cq nr" title="FKM: Não recomendado">NR</span></td><td class=""><span class="cq r" title="EPDM: Recomendado">R</span></td></tr></tbody><tbody><tr class="compat-grupo"><th colspan="9" scope="rowgroup">Cetonas</th></tr><tr class="compat-linha" data-nome="Acetona"><th scope="row">Acetona</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq nr" title="PES: Não recomendado">NR</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq r" title="Nylon: Recomendado">R</span></td><td class="compat-sep"><span class="cq nr" title="Silicone: Não recomendado">NR</span></td><td class=""><span class="cq nr" title="FKM: Não recomendado">NR</span></td><td class=""><span class="cq r" title="EPDM: Recomendado">R</span></td></tr><tr class="compat-linha" data-nome="Ciclo-hexanona"><th scope="row">Ciclo-hexanona</th><td class=""><span class="cq nr" title="PP: Não recomendado">NR</span></td><td class=""><span class="cq nr" title="PES: Não recomendado">NR</span></td><td class=""><span class="cq nr" title="PTFE: Não recomendado">NR</span></td><td class=""><span class="cq nr" title="PVDF: Não recomendado">NR</span></td><td class=""><span class="cq nr" title="Nylon: Não recomendado">NR</span></td><td class="compat-sep"><span class="cq nr" title="Silicone: Não recomendado">NR</span></td><td class=""><span class="cq nr" title="FKM: Não recomendado">NR</span></td><td class=""><span class="cq r" title="EPDM: Recomendado">R</span></td></tr><tr class="compat-linha" data-nome="Metiletilcetona (MEK)"><th scope="row">Metiletilcetona (MEK)</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq sd" title="PES: Sem dados">—</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq rl" title="PVDF: Recomendação limitada">RL</span></td><td class=""><span class="cq r" title="Nylon: Recomendado">R</span></td><td class="compat-sep"><span class="cq nr" title="Silicone: Não recomendado">NR</span></td><td class=""><span class="cq nr" title="FKM: Não recomendado">NR</span></td><td class=""><span class="cq r" title="EPDM: Recomendado">R</span></td></tr><tr class="compat-linha" data-nome="Metilisobutilcetona (MIBK)"><th scope="row">Metilisobutilcetona (MIBK)</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq nr" title="PES: Não recomendado">NR</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq rl" title="Nylon: Recomendação limitada">RL</span></td><td class="compat-sep"><span class="cq nr" title="Silicone: Não recomendado">NR</span></td><td class=""><span class="cq nr" title="FKM: Não recomendado">NR</span></td><td class=""><span class="cq rl" title="EPDM: Recomendação limitada">RL</span></td></tr></tbody><tbody><tr class="compat-grupo"><th colspan="9" scope="rowgroup">Aromáticos</th></tr><tr class="compat-linha" data-nome="Benzeno"><th scope="row">Benzeno</th><td class=""><span class="cq rl" title="PP: Recomendação limitada">RL</span></td><td class=""><span class="cq rl" title="PES: Recomendação limitada">RL</span></td><td class=""><span class="cq nr" title="PTFE: Não recomendado">NR</span></td><td class=""><span class="cq nr" title="PVDF: Não recomendado">NR</span></td><td class=""><span class="cq rl" title="Nylon: Recomendação limitada">RL</span></td><td class="compat-sep"><span class="cq nr" title="Silicone: Não recomendado">NR</span></td><td class=""><span class="cq r" title="FKM: Recomendado">R</span></td><td class=""><span class="cq nr" title="EPDM: Não recomendado">NR</span></td></tr><tr class="compat-linha" data-nome="Tolueno"><th scope="row">Tolueno</th><td class=""><span class="cq rl" title="PP: Recomendação limitada">RL</span></td><td class=""><span class="cq nr" title="PES: Não recomendado">NR</span></td><td class=""><span class="cq rl" title="PTFE: Recomendação limitada">RL</span></td><td class=""><span class="cq rl" title="PVDF: Recomendação limitada">RL</span></td><td class=""><span class="cq nr" title="Nylon: Não recomendado">NR</span></td><td class="compat-sep"><span class="cq nr" title="Silicone: Não recomendado">NR</span></td><td class=""><span class="cq r" title="FKM: Recomendado">R</span></td><td class=""><span class="cq nr" title="EPDM: Não recomendado">NR</span></td></tr><tr class="compat-linha" data-nome="Xileno"><th scope="row">Xileno</th><td class=""><span class="cq nr" title="PP: Não recomendado">NR</span></td><td class=""><span class="cq rl" title="PES: Recomendação limitada">RL</span></td><td class=""><span class="cq rl" title="PTFE: Recomendação limitada">RL</span></td><td class=""><span class="cq rl" title="PVDF: Recomendação limitada">RL</span></td><td class=""><span class="cq nr" title="Nylon: Não recomendado">NR</span></td><td class="compat-sep"><span class="cq nr" title="Silicone: Não recomendado">NR</span></td><td class=""><span class="cq r" title="FKM: Recomendado">R</span></td><td class=""><span class="cq nr" title="EPDM: Não recomendado">NR</span></td></tr></tbody><tbody><tr class="compat-grupo"><th colspan="9" scope="rowgroup">Ésteres</th></tr><tr class="compat-linha" data-nome="Acetato de amila"><th scope="row">Acetato de amila</th><td class=""><span class="cq rl" title="PP: Recomendação limitada">RL</span></td><td class=""><span class="cq sd" title="PES: Sem dados">—</span></td><td class=""><span class="cq rl" title="PTFE: Recomendação limitada">RL</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq rl" title="Nylon: Recomendação limitada">RL</span></td><td class="compat-sep"><span class="cq nr" title="Silicone: Não recomendado">NR</span></td><td class=""><span class="cq nr" title="FKM: Não recomendado">NR</span></td><td class=""><span class="cq r" title="EPDM: Recomendado">R</span></td></tr><tr class="compat-linha" data-nome="Acetato de n-butila"><th scope="row">Acetato de n-butila</th><td class=""><span class="cq rl" title="PP: Recomendação limitada">RL</span></td><td class=""><span class="cq sd" title="PES: Sem dados">—</span></td><td class=""><span class="cq rl" title="PTFE: Recomendação limitada">RL</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq rl" title="Nylon: Recomendação limitada">RL</span></td><td class="compat-sep"><span class="cq nr" title="Silicone: Não recomendado">NR</span></td><td class=""><span class="cq nr" title="FKM: Não recomendado">NR</span></td><td class=""><span class="cq r" title="EPDM: Recomendado">R</span></td></tr><tr class="compat-linha" data-nome="Acetato de etila"><th scope="row">Acetato de etila</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq rl" title="PES: Recomendação limitada">RL</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq rl" title="Nylon: Recomendação limitada">RL</span></td><td class="compat-sep"><span class="cq nr" title="Silicone: Não recomendado">NR</span></td><td class=""><span class="cq nr" title="FKM: Não recomendado">NR</span></td><td class=""><span class="cq r" title="EPDM: Recomendado">R</span></td></tr><tr class="compat-linha" data-nome="Acetato de metila"><th scope="row">Acetato de metila</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq nr" title="PES: Não recomendado">NR</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq r" title="Nylon: Recomendado">R</span></td><td class="compat-sep"><span class="cq sd" title="Silicone: Sem dados">—</span></td><td class=""><span class="cq nr" title="FKM: Não recomendado">NR</span></td><td class=""><span class="cq r" title="EPDM: Recomendado">R</span></td></tr><tr class="compat-linha" data-nome="Acetato de isopropila"><th scope="row">Acetato de isopropila</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq r" title="PES: Recomendado">R</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq r" title="Nylon: Recomendado">R</span></td><td class="compat-sep"><span class="cq rl" title="Silicone: Recomendação limitada">RL</span></td><td class=""><span class="cq nr" title="FKM: Não recomendado">NR</span></td><td class=""><span class="cq r" title="EPDM: Recomendado">R</span></td></tr></tbody><tbody><tr class="compat-grupo"><th colspan="9" scope="rowgroup">Óleos</th></tr><tr class="compat-linha" data-nome="Óleo de algodão"><th scope="row">Óleo de algodão</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq sd" title="PES: Sem dados">—</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq r" title="Nylon: Recomendado">R</span></td><td class="compat-sep"><span class="cq r" title="Silicone: Recomendado">R</span></td><td class=""><span class="cq r" title="FKM: Recomendado">R</span></td><td class=""><span class="cq rl" title="EPDM: Recomendação limitada">RL</span></td></tr><tr class="compat-linha" data-nome="Óleo lubrificante"><th scope="row">Óleo lubrificante</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq nr" title="PES: Não recomendado">NR</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq r" title="Nylon: Recomendado">R</span></td><td class="compat-sep"><span class="cq r" title="Silicone: Recomendado">R</span></td><td class=""><span class="cq r" title="FKM: Recomendado">R</span></td><td class=""><span class="cq r" title="EPDM: Recomendado">R</span></td></tr><tr class="compat-linha" data-nome="Óleo de amendoim"><th scope="row">Óleo de amendoim</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq sd" title="PES: Sem dados">—</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq r" title="Nylon: Recomendado">R</span></td><td class="compat-sep"><span class="cq r" title="Silicone: Recomendado">R</span></td><td class=""><span class="cq r" title="FKM: Recomendado">R</span></td><td class=""><span class="cq rl" title="EPDM: Recomendação limitada">RL</span></td></tr><tr class="compat-linha" data-nome="Óleo de gergelim"><th scope="row">Óleo de gergelim</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq nr" title="PES: Não recomendado">NR</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq r" title="Nylon: Recomendado">R</span></td><td class="compat-sep"><span class="cq r" title="Silicone: Recomendado">R</span></td><td class=""><span class="cq r" title="FKM: Recomendado">R</span></td><td class=""><span class="cq r" title="EPDM: Recomendado">R</span></td></tr><tr class="compat-linha" data-nome="Terebintina"><th scope="row">Terebintina</th><td class=""><span class="cq rl" title="PP: Recomendação limitada">RL</span></td><td class=""><span class="cq rl" title="PES: Recomendação limitada">RL</span></td><td class=""><span class="cq rl" title="PTFE: Recomendação limitada">RL</span></td><td class=""><span class="cq rl" title="PVDF: Recomendação limitada">RL</span></td><td class=""><span class="cq rl" title="Nylon: Recomendação limitada">RL</span></td><td class="compat-sep"><span class="cq nr" title="Silicone: Não recomendado">NR</span></td><td class=""><span class="cq r" title="FKM: Recomendado">R</span></td><td class=""><span class="cq nr" title="EPDM: Não recomendado">NR</span></td></tr></tbody><tbody><tr class="compat-grupo"><th colspan="9" scope="rowgroup">Outros</th></tr><tr class="compat-linha" data-nome="Anilina"><th scope="row">Anilina</th><td class=""><span class="cq rl" title="PP: Recomendação limitada">RL</span></td><td class=""><span class="cq nr" title="PES: Não recomendado">NR</span></td><td class=""><span class="cq rl" title="PTFE: Recomendação limitada">RL</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq rl" title="Nylon: Recomendação limitada">RL</span></td><td class="compat-sep"><span class="cq nr" title="Silicone: Não recomendado">NR</span></td><td class=""><span class="cq r" title="FKM: Recomendado">R</span></td><td class=""><span class="cq r" title="EPDM: Recomendado">R</span></td></tr><tr class="compat-linha" data-nome="Dimetilformamida (DMF)"><th scope="row">Dimetilformamida (DMF)</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq nr" title="PES: Não recomendado">NR</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq nr" title="PVDF: Não recomendado">NR</span></td><td class=""><span class="cq nr" title="Nylon: Não recomendado">NR</span></td><td class="compat-sep"><span class="cq r" title="Silicone: Recomendado">R</span></td><td class=""><span class="cq nr" title="FKM: Não recomendado">NR</span></td><td class=""><span class="cq r" title="EPDM: Recomendado">R</span></td></tr><tr class="compat-linha" data-nome="Formaldeído 37%"><th scope="row">Formaldeído 37%</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq r" title="PES: Recomendado">R</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq r" title="Nylon: Recomendado">R</span></td><td class="compat-sep"><span class="cq r" title="Silicone: Recomendado">R</span></td><td class=""><span class="cq nr" title="FKM: Não recomendado">NR</span></td><td class=""><span class="cq r" title="EPDM: Recomendado">R</span></td></tr><tr class="compat-linha" data-nome="Formaldeído 4%"><th scope="row">Formaldeído 4%</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq r" title="PES: Recomendado">R</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq r" title="Nylon: Recomendado">R</span></td><td class="compat-sep"><span class="cq r" title="Silicone: Recomendado">R</span></td><td class=""><span class="cq r" title="FKM: Recomendado">R</span></td><td class=""><span class="cq r" title="EPDM: Recomendado">R</span></td></tr><tr class="compat-linha" data-nome="Gasolina"><th scope="row">Gasolina</th><td class=""><span class="cq rl" title="PP: Recomendação limitada">RL</span></td><td class=""><span class="cq rl" title="PES: Recomendação limitada">RL</span></td><td class=""><span class="cq rl" title="PTFE: Recomendação limitada">RL</span></td><td class=""><span class="cq rl" title="PVDF: Recomendação limitada">RL</span></td><td class=""><span class="cq rl" title="Nylon: Recomendação limitada">RL</span></td><td class="compat-sep"><span class="cq nr" title="Silicone: Não recomendado">NR</span></td><td class=""><span class="cq r" title="FKM: Recomendado">R</span></td><td class=""><span class="cq r" title="EPDM: Recomendado">R</span></td></tr><tr class="compat-linha" data-nome="Etano"><th scope="row">Etano</th><td class=""><span class="cq rl" title="PP: Recomendação limitada">RL</span></td><td class=""><span class="cq nr" title="PES: Não recomendado">NR</span></td><td class=""><span class="cq rl" title="PTFE: Recomendação limitada">RL</span></td><td class=""><span class="cq rl" title="PVDF: Recomendação limitada">RL</span></td><td class=""><span class="cq rl" title="Nylon: Recomendação limitada">RL</span></td><td class="compat-sep"><span class="cq nr" title="Silicone: Não recomendado">NR</span></td><td class=""><span class="cq r" title="FKM: Recomendado">R</span></td><td class=""><span class="cq nr" title="EPDM: Não recomendado">NR</span></td></tr><tr class="compat-linha" data-nome="Querosene"><th scope="row">Querosene</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq r" title="PES: Recomendado">R</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq r" title="Nylon: Recomendado">R</span></td><td class="compat-sep"><span class="cq nr" title="Silicone: Não recomendado">NR</span></td><td class=""><span class="cq r" title="FKM: Recomendado">R</span></td><td class=""><span class="cq nr" title="EPDM: Não recomendado">NR</span></td></tr><tr class="compat-linha" data-nome="Fenol"><th scope="row">Fenol</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq nr" title="PES: Não recomendado">NR</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq r" title="Nylon: Recomendado">R</span></td><td class="compat-sep"><span class="cq nr" title="Silicone: Não recomendado">NR</span></td><td class=""><span class="cq sd" title="FKM: Sem dados">—</span></td><td class=""><span class="cq nr" title="EPDM: Não recomendado">NR</span></td></tr><tr class="compat-linha" data-nome="Acetonitrila"><th scope="row">Acetonitrila</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq r" title="PES: Recomendado">R</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq rl" title="Nylon: Recomendação limitada">RL</span></td><td class="compat-sep"><span class="cq sd" title="Silicone: Sem dados">—</span></td><td class=""><span class="cq nr" title="FKM: Não recomendado">NR</span></td><td class=""><span class="cq r" title="EPDM: Recomendado">R</span></td></tr><tr class="compat-linha" data-nome="Solução de sulfato de níquel"><th scope="row">Solução de sulfato de níquel</th><td class=""><span class="cq r" title="PP: Recomendado">R</span></td><td class=""><span class="cq sd" title="PES: Sem dados">—</span></td><td class=""><span class="cq r" title="PTFE: Recomendado">R</span></td><td class=""><span class="cq r" title="PVDF: Recomendado">R</span></td><td class=""><span class="cq r" title="Nylon: Recomendado">R</span></td><td class="compat-sep"><span class="cq r" title="Silicone: Recomendado">R</span></td><td class=""><span class="cq sd" title="FKM: Sem dados">—</span></td><td class=""><span class="cq r" title="EPDM: Recomendado">R</span></td></tr></tbody></table></div>\n        <p class="compat-vazio" id="compat-vazio" hidden>Produto químico não listado na tabela. <a href="https://wa.me/5548984691375?text=Ol%C3%A1%21%20Consultei%20o%20guia%20de%20compatibilidade%20qu%C3%ADmica%20no%20site%20da%20Verter%20e%20gostaria%20de%20avaliar%20um%20produto%20qu%C3%ADmico%20da%20minha%20aplica%C3%A7%C3%A3o.">Consulte a Verter</a> para avaliar a sua aplicação.</p>\n        <p class="compat-nota"><strong>Tabela orientativa.</strong> A compatibilidade real depende de concentração, temperatura, pressão e tempo de contato. Valide nas condições do seu processo ou consulte a Verter antes de especificar.</p>\n'},
    {id:'falhas-biocarga-filtracao-esterilizante',imagem:'/img/blog-falhas-biocarga.jpg',titulo:'Falhas de Biocarga na Filtração Esterilizante: principais causas e como preveni-las',data:'21 de setembro de 2026',dataIso:'2026-09-21',tempo:'7 min de leitura',cat:'esterilizante',catNome:'Filtração Esterilizante',featured:true,resumo:'Um filtro de 0,2 ou 0,22 µm não garante, sozinho, a esterilidade do produto. Veja as seis causas mais comuns de falha de biocarga, o papel do teste de integridade e como reduzir o risco tratando a filtração esterilizante como um sistema.',tags:['Filtração esterilizante','Bioburden','Teste de integridade','PUPSIT','Filtro 0,22 µm','PES','Validação'],conteudo:'\n        <p>A filtração esterilizante é uma das etapas mais críticas na fabricação de produtos farmacêuticos, biotecnológicos, veterinários e outras soluções que não podem ser submetidas à esterilização terminal por calor. Filtros de membrana com classificação de 0,2 µm ou 0,22 µm são amplamente utilizados como barreira microbiológica antes do envase ou em outras etapas críticas do processo.</p>\n        <p>Entretanto, existe um conceito fundamental:</p>\n        <blockquote>A simples instalação de um filtro de 0,2 ou 0,22 µm não garante, isoladamente, a esterilidade do produto.</blockquote>\n        <p>A segurança microbiológica depende do conjunto formado pelo filtro, produto, instalação, condições operacionais, procedimentos de esterilização, integridade do sistema e validação do processo. Falhas em qualquer um destes pontos podem resultar em aumento da biocarga (<em>bioburden</em>) e, nos casos mais críticos, comprometer todo um lote de produção.</p>\n\n        <h2>O que significa uma falha de biocarga?</h2>\n        <p><em>Bioburden</em> corresponde à população de microrganismos viáveis presente em uma matéria-prima, solução, equipamento ou produto antes de uma etapa de esterilização. Bactérias, fungos e outros microrganismos podem entrar no processo através de diferentes fontes:</p>\n        <ul>\n          <li>matérias-primas;</li>\n          <li>água de processo;</li>\n          <li>equipamentos e tubulações;</li>\n          <li>operadores;</li>\n          <li>gases;</li>\n          <li>tanques e conexões;</li>\n          <li>filtros;</li>\n          <li>procedimentos inadequados de limpeza ou esterilização.</li>\n        </ul>\n        <p>Em processos farmacêuticos e biotecnológicos, a contaminação microbiológica pode provocar alterações no produto, aumento de endotoxinas, perda de potência, desvios de qualidade, investigação de causa raiz, descarte de lotes e interrupções de produção.</p>\n        <img src="/img/blog-biocarga-fig1-trajetoria.png" alt="Trajetória da contaminação: microrganismos viáveis elevam a biocarga, alteram o produto e resultam em altos níveis de contaminantes e endotoxinas" class="post-figura">\n        <p>Por isso, quando ocorre uma falha microbiológica após uma etapa de filtração esterilizante, o filtro é apenas um dos componentes que precisam ser investigados.</p>\n\n        <h2>1. Seleção incorreta do filtro esterilizante</h2>\n        <p>Um dos primeiros pontos a verificar é se o elemento filtrante utilizado é realmente adequado para a aplicação. Não basta selecionar um cartucho simplesmente porque sua embalagem informa 0,2 µm. Um filtro destinado à filtração esterilizante deve possuir desempenho microbiológico devidamente caracterizado e ser compatível com as condições reais do processo.</p>\n        <p>Entre os principais fatores de seleção estão:</p>\n        <p><strong>Material da membrana.</strong> PES, PVDF, PTFE e Nylon apresentam propriedades diferentes de compatibilidade química, molhabilidade, adsorção e resistência térmica.</p>\n        <p><strong>Produto filtrado.</strong> pH, solventes, concentração de sais, proteínas, surfactantes e outros componentes podem afetar tanto a membrana quanto o comportamento hidráulico da filtração.</p>\n        <p><strong>Temperatura.</strong> A temperatura altera a viscosidade do produto e, consequentemente, a vazão e o diferencial de pressão através do elemento filtrante.</p>\n        <p><strong>Pressão diferencial.</strong> Operar fora das condições especificadas pelo fabricante pode causar deformações ou danos ao elemento.</p>\n        <p>Portanto, a especificação correta deve considerar <strong>produto + membrana + condições de processo</strong>, e não somente o tamanho de poro.</p>\n\n        <h2>2. Danos ou perda de integridade do elemento filtrante</h2>\n        <p>Mesmo um filtro esterilizante corretamente especificado pode perder sua função caso sua integridade física seja comprometida. Entre as possíveis causas estão:</p>\n        <ul>\n          <li>danos durante transporte ou armazenamento;</li>\n          <li>instalação inadequada;</li>\n          <li>deformação do cartucho;</li>\n          <li>choque de pressão;</li>\n          <li>diferencial de pressão excessivo;</li>\n          <li>temperatura acima da especificação;</li>\n          <li>incompatibilidade química;</li>\n          <li>ciclos inadequados de autoclavação ou SIP;</li>\n          <li>montagem incorreta do elemento na carcaça.</li>\n        </ul>\n        <p>Uma abertura extremamente pequena pode criar um caminho preferencial através do qual o fluido contorna a membrana esterilizante. É justamente por isso que os testes de integridade são fundamentais.</p>\n\n        <h2>3. Problemas nos O-rings, conexões e carcaças</h2>\n        <p>Outro erro comum é concentrar toda a investigação na membrana. O sistema de filtração precisa ser analisado como um conjunto. Um cartucho perfeitamente íntegro não protegerá o processo caso exista um bypass causado por:</p>\n        <ul>\n          <li>O-ring danificado;</li>\n          <li>vedação incompatível;</li>\n          <li>elemento mal encaixado;</li>\n          <li>conexão inadequada;</li>\n          <li>deformação do adaptador;</li>\n          <li>carcaça com problemas de vedação;</li>\n          <li>componentes incorretamente montados.</li>\n        </ul>\n        <p>Em sistemas sanitários, cada ponto situado após a membrana esterilizante torna-se particularmente crítico.</p>\n\n        <h2>4. Colmatação excessiva do filtro</h2>\n        <p>A colmatação, ou bloqueio progressivo da membrana, é outro fator importante. Quando um filtro esterilizante recebe uma quantidade excessiva de partículas ou contaminantes, o diferencial de pressão tende a aumentar progressivamente. Isso frequentemente significa que o problema começou antes do filtro final.</p>\n        <p>Uma estratégia adequada de pré-filtração pode proteger a membrana esterilizante, aumentar sua vida útil e tornar o processo mais previsível. Dependendo da aplicação, podem ser utilizados filtros de profundidade ou filtros absolutos intermediários antes da membrana final.</p>\n        <img src="/img/blog-biocarga-fig2-pontos-filtracao.png" alt="Pontos de filtração em uma linha de produção estéril: remoção de partículas, controle de biocarga, respiro de tanque, filtro esterilizante e filtro esterilizante de gás de processo" class="post-figura">\n        <p>O objetivo não deve ser simplesmente fazer o filtro esterilizante durar mais. O objetivo é proporcionar ao filtro final <strong>condições estáveis e validadas de operação</strong>.</p>\n\n        <h2>5. Condições de processo diferentes das condições validadas</h2>\n        <p>Vazão, pressão, temperatura, tempo de contato e volume total processado também precisam ser controlados. A regulamentação europeia para fabricação de produtos estéreis, por exemplo, considera parâmetros como:</p>\n        <ul>\n          <li>tempo de espera do produto antes da filtração;</li>\n          <li>temperatura;</li>\n          <li>vazão;</li>\n          <li>pressão máxima de operação;</li>\n          <li>diferencial de pressão;</li>\n          <li>tempo máximo de filtração;</li>\n          <li>volume máximo processado;</li>\n          <li>tempo total de contato entre produto e filtro.</li>\n        </ul>\n        <p>Diferenças relevantes entre as condições estabelecidas durante a validação e aquelas observadas durante a produção devem ser avaliadas e investigadas. Isso mostra que um filtro esterilizante não deve ser tratado simplesmente como um componente instalado na linha: ele faz parte de um processo de filtração validado.</p>\n\n        <h2>6. Pontos de estagnação e contaminação do sistema</h2>\n        <p>Nem toda contaminação encontrada depois de um filtro teve necessariamente origem no próprio filtro. Tubulações, válvulas, mangueiras, tanques e pontos de amostragem podem representar fontes de contaminação. Áreas com baixa circulação ou líquido estagnado merecem atenção especial.</p>\n        <p>Após a filtração esterilizante, qualquer ponto de contato com o produto precisa fazer parte da estratégia de controle microbiológico. Por isso, o projeto sanitário do sistema é tão importante quanto a escolha do elemento filtrante.</p>\n\n        <h2>O teste de integridade é fundamental</h2>\n        <p>Os testes de integridade permitem verificar se a membrana e o conjunto filtrante continuam apresentando as características correlacionadas à capacidade de retenção microbiológica estabelecida durante a validação. Entre os métodos mais utilizados estão:</p>\n        <ul>\n          <li><strong>Bubble Point</strong> — ponto de bolha;</li>\n          <li><strong>Diffusive Flow</strong> — fluxo difusivo;</li>\n          <li><strong>Pressure Hold</strong> — queda/manutenção de pressão;</li>\n          <li><strong>Water Intrusion Test</strong> — especialmente em determinadas aplicações com membranas hidrofóbicas.</li>\n        </ul>\n        <p>O FDA recomenda o teste de integridade após a filtração para detectar vazamentos ou perfurações que possam ter ocorrido durante o processo. O EU GMP Annex 1 estabelece ainda a verificação da integridade do conjunto esterilizado antes do uso — conhecida como <strong>PUPSIT</strong>, <em>Pre-Use Post-Sterilization Integrity Test</em> — quando aplicável, além do teste não destrutivo após o uso.</p>\n        <p>Assim, um filtro que simplesmente "parece normal" após o processo não necessariamente possui integridade comprovada.</p>\n\n        <h2>Um filtro 0,22 µm é automaticamente um filtro esterilizante?</h2>\n        <p>Não necessariamente. Esta é uma distinção extremamente importante. O tamanho nominal de poro é apenas uma das características do elemento. Para aplicações críticas, deve existir evidência de retenção microbiológica associada ao filtro e às condições para as quais ele foi desenvolvido.</p>\n        <p>A FDA estabelece que um filtro esterilizante deve ser validado para remover de forma reproduzível microrganismos viáveis do fluxo de processo. Para filtros classificados como 0,2 µm, <em>Brevundimonas diminuta</em> (ATCC 19146) é tradicionalmente utilizada como organismo de desafio devido ao seu pequeno tamanho. A validação utiliza normalmente um desafio mínimo de:</p>\n        <blockquote>10⁷ UFC/cm² de área efetiva de filtração, sem passagem detectável do microrganismo de desafio.</blockquote>\n        <p>Além da qualificação do próprio filtro, aplicações farmacêuticas críticas podem exigir estudos específicos considerando o produto e as condições reais ou <em>worst case</em> do processo.</p>\n\n        <h2>Como reduzir o risco de falhas de biocarga?</h2>\n        <p>Uma estratégia consistente de filtração esterilizante deve considerar diversos pontos simultaneamente:</p>\n        <ul>\n          <li>Selecionar uma membrana compatível com o produto.</li>\n          <li>Utilizar filtros adequadamente qualificados para aplicações esterilizantes.</li>\n          <li>Dimensionar corretamente a área efetiva de filtração.</li>\n          <li>Implementar pré-filtração quando a carga de partículas ou contaminantes justificar.</li>\n          <li>Monitorar o diferencial de pressão durante o processo.</li>\n          <li>Controlar vazão, temperatura, volume e tempo de filtração.</li>\n          <li>Garantir instalação correta dos elementos e vedações.</li>\n          <li>Validar os ciclos de esterilização utilizados.</li>\n          <li>Realizar testes de integridade conforme o processo e os requisitos aplicáveis.</li>\n          <li>Investigar não apenas o filtro, mas toda a linha situada antes e depois da barreira esterilizante.</li>\n        </ul>\n        <img src="/img/blog-biocarga-fig3-avaliacao-risco.png" alt="Avaliação de risco em três camadas de controle: prevenir as fontes de contaminação, mitigar com barreiras de processo como a filtração esterilizante e detectar por monitoramento microbiológico" class="post-figura">\n\n        <h2>Filtração esterilizante deve ser tratada como um sistema</h2>\n        <p>Quando ocorre uma falha microbiológica, substituir simplesmente um cartucho por outro pode não solucionar a causa do problema. É necessário compreender o processo. Em muitos casos, melhorias significativas podem ser obtidas através da combinação adequada entre pré-filtração, área filtrante, membrana esterilizante e condições operacionais.</p>\n        <p>A Verter Filtração auxilia na seleção e no dimensionamento de sistemas de filtração para aplicações farmacêuticas, veterinárias, biotecnológicas e de alta pureza, incluindo filtros em PES, PVDF, PTFE, Nylon e diferentes tecnologias de pré-filtração. Também avaliamos alternativas técnicas e equivalências para filtros utilizados em processos existentes, sempre considerando características construtivas, condições de operação e requisitos da aplicação.</p>\n        <p>Está enfrentando baixa vida útil do filtro, aumento excessivo do diferencial de pressão, falhas de integridade ou problemas de biocarga? Entre em contato com a Verter Filtração. A análise do processo completo frequentemente permite identificar oportunidades de melhoria que não são visíveis quando se considera apenas o tamanho de poro do filtro.</p>\n'},
    {
      id:'pre-molhamento',
    ...
    {
      id:'quantos-filtros',
      imagem:'/img/blog-quantos-filtros-v2.jpg',
    ...
    {
      id:'fda-usp-nsf',
      imagem:'/img/blog-fda-usp-nsf-v2.jpg',
  ...
  const categorias = [
    ...
    {id:'pp',nome:'Cartuchos Absolutos PP e GF (Fibra de Vidro)'},
    ...
    {id:'codeline',nome:'Peças Codeline para Protec/Wave Cyber'},
  ];
  ...
  const produtos = [
    ...
    {id:56,slug:'pecas-protec-arisawa',nome:'Peças Protec-Arisawa',cat:'codeline',catNome:'Peças Codeline para Protec/Wave Cyber',desc:'Peças, componentes e acessórios compatíveis com vasos de pressão Protec-Arisawa para osmose reversa.',tag:'novo',ph:'carcaca',img:'img/pecas-protec-arisawa.png',secoes:[{titulo:'DESCRIÇÃO DO PRODUTO',paragrafo:'Fornecemos peças, componentes e acessórios compatíveis com vasos de pressão Protec-Arisawa, atendendo necessidades de manutenção preventiva, corretiva e reposição de componentes em sistemas de osmose reversa. Trabalhamos com identificação por part number, modelo do vaso ou especificação técnica, o que dá mais segurança na seleção da peça correta para cada aplicação.'},{titulo:'COMPONENTES DISPONÍVEIS',bullets:['O-rings e elementos de vedação','Anéis de retenção','Placas e conjuntos de fechamento','End caps e componentes internos','Adaptadores e conexões','Portas de alimentação e concentrado','Componentes para vasos de 4" e 8"','Peças para manutenção de vasos das séries PRO','Kits e componentes de reposição conforme part number']},{titulo:'COMO IDENTIFICAR A PEÇA',paragrafo:'Envie o código Protec-Arisawa, o modelo do vaso ou uma fotografia do componente. Nossa equipe auxilia na identificação e prepara a cotação com rapidez.'},{titulo:'ATENDIMENTO',bullets:['Orçamentos rápidos','Suporte técnico para identificação dos componentes','Prazos de entrega compatíveis com a necessidade de manutenção','Alternativas para itens de reposição de maior utilização no mercado brasileiro']}]},
    {id:57,slug:'pecas-wave-cyber',nome:'Peças Wave Cyber',cat:'codeline',catNome:'Peças Codeline para Protec/Wave Cyber',desc:'Peças, componentes e acessórios compatíveis com vasos de pressão Wave Cyber para osmose reversa e tratamento de água.',tag:'novo',ph:'carcaca',img:'img/pecas-wave-cyber.png',secoes:[{titulo:'DESCRIÇÃO DO PRODUTO',paragrafo:'Fornecemos peças, componentes e acessórios compatíveis com vasos de pressão Wave Cyber, destinados à manutenção preventiva, corretiva e reposição de componentes em sistemas de osmose reversa e tratamento de água. A identificação pode ser feita pelo part number, modelo do vaso, dimensões ou especificação técnica do componente, o que dá mais segurança na seleção da peça correta e reduz riscos durante intervenções de manutenção.'},{titulo:'COMPONENTES DISPONÍVEIS',bullets:['O-rings e elementos de vedação','Anéis de retenção','Placas e conjuntos de fechamento','End caps e componentes internos','Adaptadores e conexões','Portas de alimentação e concentrado','Componentes para vasos de diferentes diâmetros','Kits e conjuntos para manutenção','Peças específicas conforme part number ou modelo do vaso']},{titulo:'COMO IDENTIFICAR A PEÇA',paragrafo:'Envie o código do componente, o modelo do vaso, as medidas ou uma fotografia da peça. Nossa equipe auxilia na identificação e prepara a cotação com rapidez.'},{titulo:'ATENDIMENTO',bullets:['Orçamentos rápidos','Suporte técnico para identificação dos componentes','Prazos de entrega competitivos','Atendimento a diferentes configurações e modelos de vasos Wave Cyber']}]},
  ];
  ...
  function getFilteredProducts(){
    let list = currentCategory === 'all' ? produtos : produtos.filter(p => p.cat === currentCategory);
    const q = normTxt(currentQuery).trim();
    if(q){
      const termos = q.split(/\s+/);
      list = list.filter(p => {
        const alvo = normTxt([p.nome, p.desc, p.catNome, (p.slug||'').replace(/-/g,' ')].join(' '));
  ...
  (function(){
    ...
    campo.addEventListener('input', function(){
      clearTimeout(t);
      const v = this.value;
      t = setTimeout(function(){ currentQuery = v; currentPage = 1; renderAll(); }, 120);
    });
    campo.addEventListener('keydown', function(e){ if(e.key === 'Escape'){ this.value = ''; currentQuery = ''; currentPage = 1; renderAll(); } });
  })();
  ...
  function renderProducts(list){
    ...
    if(!list.length){
      ...
      grid.innerHTML = '<div class="prod-vazio" style="grid-column:1/-1;padding:36px 24px;background:var(--paper);border:1px solid var(--line);border-radius:14px;color:var(--body);line-height:1.6">'
        + 'Nenhum produto encontrado' + (q ? ' para «<b style="color:var(--navy)">' + q.replace(/[&<>]/g,'') + '</b>»' : ' nesta categoria') + '. '
        + 'Se você procura pelo código de um filtro de outro fabricante, use a <a href="/equivalencias" style="color:#1558c0;font-weight:600">busca por código nas tabelas de equivalência</a>.'
        + '</div>';
      return;
    }
    list.forEach(p=>{
...
/* ================================================================
   GUIA DE COMPATIBILIDADE QUÍMICA — busca na tabela do post
   (por delegação: funciona sempre que o post for aberto)
   ================================================================ */
document.addEventListener('input', function(e){
  if(!e.target || e.target.id !== 'compat-busca') return;
  var norm = function(s){ return (s||'').toLowerCase().normalize('NFD').replace(/[\u0300-\u036f]/g,''); };
  var q = norm(e.target.value).trim(), achou = 0;
  document.querySelectorAll('.compat-tabela tbody').forEach(function(tb){
    var vis = 0;
    tb.querySelectorAll('tr.compat-linha').forEach(function(tr){
      var ok = !q || norm(tr.getAttribute('data-nome')).indexOf(q) >= 0;
      tr.hidden = !ok; if(ok) vis++;
    });
    var cab = tb.querySelector('tr.compat-grupo');
    if(cab) cab.hidden = vis === 0;
    achou += vis;
  });
  var v = document.getElementById('compat-vazio');
  if(v) v.hidden = achou > 0;
});
